...
function getPolynom(...args) {
  const argumentsFunc = Array.from(args).reverse();
  return (x) => argumentsFunc.reduce((result, item, i) => result + item * (x ** i), 0);
}
...
// const array = Array.from(...args, ...args1);
// const sums = array.reduce((sum, item) => sum + item);
// return sums;
